...
namespace UIMapToolbox.VSPackage
{
    ...
    [Guid(GuidList.guidUIMapToolbox_VSPackagePkgString)]
    public sealed class UIMapToolbox_VSPackagePackage : Package
    {
        private UIMapToolbox.UI.MainForm _uiMapToolboxForm;
        ...
        /// </summary>
        public UIMapToolbox_VSPackagePackage()
        {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidUIMapToolbox_VSPackageCmdSet, (int)PkgCmdIDList.cmdidOpenInUIMapToolbox);
